...
const funnelStages = [
    { name: "Avaliação 1", client: "Pedro L.", cashback: 88.23, code: "XYZA", htmlId: "evaluation-0" },
    { name: "Avaliação 2", client: "Gabriel M.", cashback: 88.05, code: "IJKL", htmlId: "evaluation-1" },
    { name: "Avaliação 3", client: "Fernanda G.", cashback: 89.01, code: "MNOP", htmlId: "evaluation-2" }
];
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    watchVideoButton.addEventListener('click', () => {
        // Redireciona DIRETAMENTE para a pasta VSL, sem exibir o alerta.
        (() => {
          const next = new URL("../vsl2", window.location.href);

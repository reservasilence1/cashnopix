        ...
        var o = n(4887)
          ...
          , c = function(e) {
            ...
            l(t, [{
                ...
                key: "render",
                value: function() {
                    return s ? (this.props.node || this.defaultNode || (this.defaultNode = document.createElement("div"),
                    document.body.appendChild(this.defaultNode)),
                    o.createPortal(this.props.children, this.props.node || this.defaultNode)) : null
                }
            }]),
            t
        }(r.Component);
          ...
          , p = function(e) {
            ...
            a(t, [{
                ...
                value: function(e) {
                    ...
                    "function" == typeof this.props.children.type && (t = r.cloneElement(this.props.children)),
    ...
    8614: function(e, t, n) {
        ...
        function a(e) {
            ...
            r.useInsertionEffect)( () => {
                let {width: e, height: t, top: o, left: r} = s.current;
                if (n || !u.current || !e || !t)
                    return;
                u.current.dataset.motionPopId = i;
        ...
        let p = e => {
            let {children: t, initial: n, isPresent: i, onExitComplete: l, custom: c, presenceAffectsLayout: p, mode: d} = e
              , h = (0,
            u.h)(f)
              , y = (0,
            r.useId)()
        ...
        var m = n(1534);
        let b = e => {
            let {children: t, custom: n, initial: s=!0, onExitComplete: l, presenceAffectsLayout: c=!0, mode: a="sync", propagate: f=!1} = e
              , [b,v] = (0,
            d.oO)(f)
              , _ = (0,
            r.useMemo)( () => y(t), [t])
            ...
            m.L)( () => {
                ...
                for (let e = 0; e < j.length; e++) {
                    let t = h(j[e]);
                    E.includes(t) ? P.delete(t) : !0 !== P.get(t) && P.set(t, !1)
                }
            }
            , [j, E.length, E.join("-")]);
            let k = [];
            ...
            o.jsx)(o.Fragment, {
                children: j.map(e => {
                    let t = h(e)
                      , r = (!f || !!b) && (_ === j || E.includes(t));
                    return (0,
                    o.jsx)(p, {
                        isPresent: r,
                        initial: (!O.current || !!s) && void 0,
                        custom: r ? void 0 : n,
